...
var getCtrlItem = function getCtrlItem(node, key) {
  ...
  return React__default.createElement(AmButton, Object.assign({
    key: key,
    type: "link"
  }, props));
};
...
var getCtrlList = function getCtrlList(children) {
  ...
  children.forEach(function (node, i) {
    ...
    if (props.confirm) {
      CtrlItem = React__default.createElement(antd.Popconfirm, {
        key: i,
...
var getTag = function getTag(field, fields, setFieldsValue, readonly) {
  ...
  switch (type) {
    ...
    case FORM_TYPE_EDITOR:
      tag = React__default.createElement(AmEditor, Object.assign({}, tagProps));
      break;

    case FORM_TYPE_SELECT:
      tag = React__default.createElement(AmSelect, Object.assign({}, tagProps));
      break;
...
var AmForm = React.forwardRef(function AmForm(props, ref) {
...
var dialogResolve;
var AmDialogForm = React.forwardRef(function AmDialogForm(props, ref) {
  var fields = props.fields,
      title = props.title,
      addApi = props.addApi,
  ...
  return React__default.createElement(AmDialog, Object.assign({
    width: width,
    ...
    onConfirm: onConfirm,
    loading: loading,
    footer: mode === MODE_VIEW ? React__default.createElement(AmButton, {
      onClick: function onClick() {
        return setVisible(false);
      }
    }, "\u5173\u95ED") : undefined
  }, props), React__default.createElement(AmForm, {
    name: name,
...
var AmSearch = React.forwardRef(function AmSearch(props, ref) {
  var fields = props.fields,
      onConfirm = props.onConfirm;
  ...
  var ToogleBtn = React__default.createElement(AmButton, {
    type: "link",
    onClick: toggleMini
  ...
  return React__default.createElement(antd.Card, {
    className: "am-search"
  }, React__default.createElement(AmForm, {
    ref: formRef,
    fields: searchFields,
    span: 8,
  ...
  }, React__default.createElement(antd.Space, null, React__default.createElement(AmButton, {
    htmlType: "submit",
    type: "primary",
    icon: React__default.createElement(SearchOutlined, null)
  }, "\u67E5\u8BE2"), React__default.createElement(AmButton, {
...
var AmTable = React.forwardRef(function AmTable(props, ref) {
  ...
  return React__default.createElement(antd.Card, {
    ...
    color: "cyan"
  }, total, " \u6761")) : null, exportVisible && api && React__default.createElement(AmButton, {
...
function useSelection(_props) {
  ...
  var header = selectionKeys.length ? React__default.createElement(Alert, {
    ...
    message: React__default.createElement("div", null, React__default.createElement("span", null, "\u5DF2\u9009\u62E9\uFF1A", React__default.createElement(antd.Popover, {
      title: "\u5DF2\u7ECF\u9009\u4E2D\u7684\u9009\u9879",
      content: popContent
    }, React__default.createElement("a", null, selection.length)), ' ', "\u6761"), React__default.createElement(AmButton, {
      className: "ml",
      type: "link",
      size: "small",
    ...
    if (child.props.directive) {
      ...
      switch (child.props.directive) {
        case 'add':
          ...
          extendProps.icon = React__default.createElement(PlusOutlined, null);
          break;
        ...
        case 'batch-delete':
            ...
            if (selection.length === 0) {
              ...
              if (deleteApi) {
                antd.Modal.confirm({
                  ...
                  icon: React__default.createElement(ExclamationCircleOutlined$1, null),
                  onOk: function onOk() {
          ...
          extendProps.onClick = func;
          extendProps.icon = React__default.createElement(DeleteOutlined, null);
          break;
    ...
    if (Array.isArray(ctrlChildren)) {
      newCtrl = _objectSpread2(_objectSpread2({}, ctrl), {}, {
        render: function render(text, record, index) {
          ...
          return React__default.createElement(AmCtrl, null, ctrlChildren.map(function (child, i) {
            return getChild({
              child: child,
              props: props,
              renderParams: {
...
var AmSearchTableContext = React.createContext({});
/**
...
var AmSearchTable = React.forwardRef(function AmSearchTable(props, ref) {
  var fields = props.fields,
      api = props.api,
      deleteApi = props.deleteApi,
      children = props.children,
  ...
  }, React__default.createElement(AmSearchTableContext.Provider, {
    value: newCtrl
  }, searchVisible !== false ? React__default.createElement(AmSearch, {
    ref: searchRef,
    fields: searchFields,
    onConfirm: onConfirm
  }) : null, center, React__default.createElement(AmTable, Object.assign({}, tableProps, {
    fields: tableFields,
    header: header
  }), dialogFormExtend ? React__default.createElement(AmDialogForm, Object.assign({
    ref: formRef
