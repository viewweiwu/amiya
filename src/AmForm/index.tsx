...
import { AmFormField } from './am-form'
moment.locale('zh-cn')

interface DpFormProps {
  /** 配置项 */
  fields: Array<AmFormField>
  /** form 名称 */
  name?: string
  /** 子元素 */
  children?: ReactNode
 ...
 * @param field 配置项
 */
const getNoVisibleField = (field: AmFormField): AmFormField => {
  return {
    ...field,
    title: '',
    type: 'empty'
 ...
 * @param fields 配置列表
 */
export const getDefaultValue = (fields: Array<AmFormField | AmSearchField>) => {
  let form: AnyKeyProps = {}
  fields.forEach((field: AmFormField | AmSearchField) => {
 ...
 * @param field 配置项
 */
const getPlaceholder = (field: AmFormField): string => {
 ...
 * @param field 配置项
 */
const getTagProps = (field: AmFormField, setFieldsValue: (params: AnyKeyProps) => void, readonly?: boolean) => {
 ...
 * @param field 配置项
 */
const getTag = (field: AmFormField, fields: Array<AmFormField>, setFieldsValue: (params: AnyKeyProps) => void, readonly?: boolean) => {
  const { type } = field
  ...
  switch (type) {
    ...
    case FORM_TYPE_EDITOR:
      tag = <AmEditor {...tagProps} />
      break

    case FORM_TYPE_SELECT:
      tag = <AmSelect {...tagProps} />
      break
 ...
 */
const getFormItem = (fields: Array<AmFormField>, setFieldsValue: (params: AnyKeyProps) => void, span?: number, readonly?: boolean) => {
  return fields.map((field: AmFormField) => {
    let visible = true
 ...
 * @param fields 配置项
 */
const formatValues = (values: AnyKeyProps, fields: Array<AmFormField>): AnyKeyProps => {
 ...
 */
const handleConfirm = (values: AnyKeyProps, fields: Array<AmFormField>, onConfirm?: (values: AnyKeyProps) => void) => {
  if (onConfirm) {
 ...
 */
const handleChange = (changedValues: AnyKeyProps, allValues: AnyKeyProps, fields: Array<AmFormField>, setFieldsValue: (params: AnyKeyProps) => void, setRefresh: any) => {
...
export default forwardRef(function AmForm(props: DpFormProps, ref: Ref<any>) {
